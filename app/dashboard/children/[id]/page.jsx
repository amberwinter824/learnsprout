// app/dashboard/children/[id]/page.jsx
"use client"
import { useState, useEffect } from 'react';
import Link from 'next/link';
import { useRouter } from 'next/navigation';
import { getChild, getUserChildren } from '@/lib/dataService';
...
export default function ChildProfilePage({ params }) {
  ...
  if (!child) {
    return <div>No child found with this ID</div>;
  }

  return (
    <div>
      <div className="mb-6">
        <Link href="/dashboard" className="inline-flex items-center text-emerald-500 hover:text-emerald-600">
      ...
      <div className="grid grid-cols-1 gap-6 mb-6">
        {/* Child Skill Progress - New Component */}
