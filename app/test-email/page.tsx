      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <h2 className="text-lg font-medium text-gray-900 mb-2">Need to test weekly plan emails?</h2>
            <p className="text-sm text-gray-600 mb-4">
              To test the weekly plan emails with fully customizable options, use our advanced testing page:
            </p>
            <Link 
              href="/test-emails"
