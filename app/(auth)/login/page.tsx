...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (!authLoading) {
      if (currentUser) {
        console.log(`Login page: User already logged in with role ${activeRole}, redirecting`);
  ...
  }, [currentUser, authLoading, activeRole, router]);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <Loader2 className="animate-spin h-12 w-12 text-emerald-500 mx-auto" />
